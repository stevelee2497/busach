...
columns = ['name', 'description', 'bookCoverUrl', 'author', 'categories']
geckodriver = basePath.joinpath('geckodriver.exe')
csvPath = basePath.joinpath('allnovel.net/allnovel.net.csv')
...
def crawlSiteData(driver, site):
    ...
    return {'name': name, 'description': description, 'bookCoverUrl': bookCoverUrl, 'author': author, 'categories': categories}
